...
const TermsOfUse: React.FC = () => {
  ...
  const contentFR = (
    <>
      ...
      <ul className="list-disc list-inside mb-4 space-y-1 text-muted-foreground">
        <li>Journal de trading avec historique complet et images</li>
        ...
        <li>Système de défis, récompenses et gamification</li>
        <li>Assistant IA avec résumé quotidien personnalisé</li>
        <li>Comparaison de périodes et export PDF</li>
      ...
      <h2 className="text-xl font-bold text-foreground mt-8 mb-4">11. Contact</h2>
      <p className="text-muted-foreground mb-4">
  ...
  const contentEN = (
    <>
      ...
      <ul className="list-disc list-inside mb-4 space-y-1 text-muted-foreground">
        <li>Trading journal with complete history and images</li>
        ...
        <li>Challenges, rewards and gamification system</li>
        <li>AI assistant with personalized daily summary</li>
        <li>Period comparison and PDF export</li>
