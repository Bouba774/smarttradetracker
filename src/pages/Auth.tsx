    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-muted-foreground text-sm">{language === 'fr' ? 'Chargement...' : 'Loading...'}</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Link
          to="/"
          className="group inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-all duration-300 mb-6"
        >
        ...
        <div className="relative glass-card p-8 animate-fade-in overflow-hidden" style={{ animationDelay: '200ms' }}>
          ...
          {authStep === 'credentials' && (
            <>
              {isForgotPassword ? (
                ...
                <div className="relative flex mb-8 bg-secondary/30 rounded-lg p-1">
                  {/* Sliding indicator */}
                  <div 
                    className="absolute top-1 bottom-1 w-[calc(50%-4px)] bg-gradient-primary rounded-md transition-all duration-300 ease-out shadow-neon"
                    style={{ left: isLogin ? '4px' : 'calc(50% + 0px)' }}
                  />
                  <button
                    onClick={() => setIsLogin(true)}
                    className={`relative z-10 flex-1 py-2.5 text-sm font-medium transition-all duration-300 rounded-md ${
                      isLogin 
              ...
              {!isForgotPassword && (
                <>
                  <Button
                    ...
                    className="group w-full h-12 mb-5 bg-card hover:bg-secondary/80 border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-neon"
                  >
                    {isGoogleLoading ? (
                  ...
                  <div className="relative mb-5">
                    ...
                    <div className="relative flex justify-center">
                      <span className="px-4 text-xs text-muted-foreground bg-card uppercase tracking-wider">{t('or')}</span>
                    </div>
                  </div>
                </>
              )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2 animate-fade-in" style={{ animationDelay: '50ms' }}>
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`pl-10 h-11 bg-secondary/30 border-border/50 focus:border-primary/50 focus:bg-secondary/50 transition-all duration-300 ${errors.nickname ? 'border-loss' : ''}`}
            ...
            <div className="space-y-2 animate-fade-in" style={{ animationDelay: '100ms' }}>
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className={`pl-10 h-11 bg-secondary/30 border-border/50 focus:border-primary/50 focus:bg-secondary/50 transition-all duration-300 ${errors.email ? 'border-loss' : ''}`}
              ...
              <div className="space-y-2 animate-fade-in" style={{ animationDelay: '150ms' }}>
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`pl-10 pr-10 h-11 bg-secondary/30 border-border/50 focus:border-primary/50 focus:bg-secondary/50 transition-all duration-300 ${errors.password ? 'border-loss' : ''}`}
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
            ...
            <Button
              ...
              className="group w-full bg-gradient-primary hover:opacity-90 font-display h-12 shadow-neon transition-all duration-300 hover:shadow-[0_0_30px_hsl(var(--primary)/0.4)]"
            >
              {isSubmitting ? (
                ...
                <div className="flex items-center gap-2">
                  <Zap className="w-4 h-4 transition-transform group-hover:scale-110 duration-300" />
            ...
            {!isForgotPassword && (
              <p className="text-xs text-muted-foreground text-center mt-4 leading-relaxed">
                {t('consentMessage')}{' '}
                <Link to="/privacy-policy" className="text-primary hover:text-profit transition-colors hover:underline">
                  {t('privacyRules')}
                </Link>
                {' '}{t('and_connector')}{' '}
                <Link to="/terms-of-use" className="text-primary hover:text-profit transition-colors hover:underline">
                  {t('termsOfUse')}
                </Link>
                .
              </p>
